...
type UserClient interface {
	...
	UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*CheckResponse, error)
...
func (c *userClient) UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*CheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServer interface {
	...
	UpdateUser(context.Context, *UpdateUserInfo) (*CheckResponse, error)
...
func (UnimplementedUserServer) UpdateUser(context.Context, *UpdateUserInfo) (*CheckResponse, error) {
